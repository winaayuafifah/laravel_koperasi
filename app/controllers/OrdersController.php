...
class OrdersController extends BaseController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("invoice","customer_id","customer_name","customer_phone","customer_address","district_id","subtotal","status","tracking_number","created_at","updated_at");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","invoice","customer_id","customer_name","customer_phone","customer_address","district_id","subtotal","status","tracking_number","created_at","updated_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'invoice' => 'required',
