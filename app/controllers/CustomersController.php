...
class CustomersController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				customers.password LIKE ? OR 
				customers.phone_number LIKE ? OR 
				customers.address LIKE ? OR 
				customers.district_id LIKE ? OR 
				customers.activate_token LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("name","email","password","phone_number","address","district_id","activate_token","status","created_at","updated_at");
			...
			$this->sanitize_array = array(
				...
				'activate_token' => 'sanitize_string',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","name","email","password","phone_number","address","district_id","activate_token","status","created_at","updated_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$cpassword = $postdata['confirm_password'];
			$password = $postdata['password'];
