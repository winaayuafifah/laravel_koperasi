...
class PaymentsController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				payments.id LIKE ? OR 
				payments.order_id LIKE ? OR 
				payments.name LIKE ? OR 
				payments.transfer_to LIKE ? OR 
				payments.transfer_date LIKE ? OR 
				payments.amount LIKE ? OR 
				payments.proof LIKE ? OR 
				payments.status LIKE ? OR 
				payments.created_at LIKE ? OR 
				payments.updated_at LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("order_id","name","transfer_to","transfer_date","amount","proof","status","created_at","updated_at");
			...
			$this->sanitize_array = array(
				...
				'transfer_to' => 'sanitize_string',
				'transfer_date' => 'sanitize_string',
				'amount' => 'sanitize_string',
				'proof' => 'sanitize_string',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","order_id","name","transfer_to","transfer_date","amount","proof","status","created_at","updated_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'order_id' => 'required|numeric',
