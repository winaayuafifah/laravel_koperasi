                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-invoice"> Invoice</th>
                                                ...
                                                <th  class="td-customer_address"> Customer Address</th>
                                                <th  class="td-district_id"> District Id</th>
                                                <th  class="td-subtotal"> Subtotal</th>
                                                <th  class="td-status"> Status</th>
                                                <th  class="td-tracking_number"> Tracking Number</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-customer_address">
                                                        <span  data-value="<?php echo $data['customer_address']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("orders/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="customer_address" 
                                                            data-title="Enter Customer Address" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
                                                    ...
                                                    <td class="td-district_id">
                                                        <span  data-value="<?php echo $data['district_id']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("orders/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="district_id" 
                                                            data-title="Enter District Id" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="number" 
                                                            data-mode="popover" 
                                                    ...
                                                    <td class="td-tracking_number">
                                                        <span  data-value="<?php echo $data['tracking_number']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("orders/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="tracking_number" 
                                                            data-title="Enter Tracking Number" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
