                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-transfer_to"  value="<?php  echo $this->set_field_value('transfer_to',""); ?>" type="text" placeholder="Enter Transfer To"  required="" name="transfer_to"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-proof"  value="<?php  echo $this->set_field_value('proof',""); ?>" type="text" placeholder="Enter Proof"  required="" name="proof"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
