                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label class="control-label" for="transfer_to">Transfer To <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-transfer_to"  value="<?php  echo $data['transfer_to']; ?>" type="text" placeholder="Enter Transfer To"  required="" name="transfer_to"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label class="control-label" for="transfer_date">Transfer Date <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                            <input id="ctrl-transfer_date" class="form-control datepicker  datepicker"  required="" value="<?php  echo $data['transfer_date']; ?>" type="datetime" name="transfer_date" placeholder="Enter Transfer Date" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                                <label class="control-label" for="proof">Proof <span class="text-danger">*</span></label>
                                                            </div>
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-proof"  value="<?php  echo $data['proof']; ?>" type="text" placeholder="Enter Proof"  required="" name="proof"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
