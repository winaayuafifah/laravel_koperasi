                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <label class="control-label" for="activate_token">Activate Token <span class="text-danger">*</span></label>
                                                                </div>
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-activate_token"  value="<?php  echo $this->set_field_value('activate_token',""); ?>" type="text" placeholder="Enter Activate Token"  required="" name="activate_token"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
