                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-district_id"  value="<?php  echo $data['district_id']; ?>" type="number" placeholder="Enter District Id" step="1"  required="" name="district_id"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-activate_token"  value="<?php  echo $data['activate_token']; ?>" type="text" placeholder="Enter Activate Token"  required="" name="activate_token"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
