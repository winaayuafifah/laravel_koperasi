                        ...
                        <form id="cities-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("cities/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="province_id">Province Id <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-province_id"  value="<?php  echo $this->set_field_value('province_id',""); ?>" type="number" placeholder="Enter Province Id" step="1"  required="" name="province_id"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label class="control-label" for="postal_code">Postal Code <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-postal_code"  value="<?php  echo $this->set_field_value('postal_code',""); ?>" type="text" placeholder="Enter Postal Code"  required="" name="postal_code"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
