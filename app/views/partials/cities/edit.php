                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-province_id"  value="<?php  echo $data['province_id']; ?>" type="number" placeholder="Enter Province Id" step="1"  required="" name="province_id"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-postal_code"  value="<?php  echo $data['postal_code']; ?>" type="text" placeholder="Enter Postal Code"  required="" name="postal_code"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
